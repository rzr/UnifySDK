...
#define ZAP_GENERATED_ATTRIBUTE_SIZES { \
  ...
  ZCL_SINGLE_ATTRIBUTE_TYPE, 4, \
  ZCL_DOUBLE_ATTRIBUTE_TYPE, 8, \
  ZCL_OCTSTR16_ATTRIBUTE_TYPE, 2, \
  ZCL_STRING16_ATTRIBUTE_TYPE, 2, \
  ZCL_TO_D_ATTRIBUTE_TYPE, 4, \
  ZCL_DATE_ATTRIBUTE_TYPE, 4, \
  ZCL_UTC_ATTRIBUTE_TYPE, 4, \
  ZCL_CLUSTER_ID_ATTRIBUTE_TYPE, 2, \
  ZCL_ATTRIB_ID_ATTRIBUTE_TYPE, 2, \
  ZCL_BAC_OID_ATTRIBUTE_TYPE, 4, \
