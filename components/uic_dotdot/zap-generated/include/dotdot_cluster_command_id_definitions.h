...
#define DOTDOT_DOOR_LOCK_SET_PIN_CODE_COMMAND_ID (0x5)
#define DOTDOT_DOOR_LOCK_SET_PIN_CODE_RESPONSE_COMMAND_ID (0x5)
#define DOTDOT_DOOR_LOCK_GET_PIN_CODE_COMMAND_ID (0x6)
#define DOTDOT_DOOR_LOCK_GET_PIN_CODE_RESPONSE_COMMAND_ID (0x6)
#define DOTDOT_DOOR_LOCK_CLEAR_PIN_CODE_COMMAND_ID (0x7)
#define DOTDOT_DOOR_LOCK_CLEAR_PIN_CODE_RESPONSE_COMMAND_ID (0x7)
#define DOTDOT_DOOR_LOCK_CLEAR_ALL_PIN_CODES_COMMAND_ID (0x8)
#define DOTDOT_DOOR_LOCK_CLEAR_ALL_PIN_CODES_RESPONSE_COMMAND_ID (0x8)
...
#define DOTDOT_DOOR_LOCK_SET_RFID_CODE_COMMAND_ID (0x16)
#define DOTDOT_DOOR_LOCK_SET_RFID_CODE_RESPONSE_COMMAND_ID (0x16)
#define DOTDOT_DOOR_LOCK_GET_RFID_CODE_COMMAND_ID (0x17)
#define DOTDOT_DOOR_LOCK_GET_RFID_CODE_RESPONSE_COMMAND_ID (0x17)
#define DOTDOT_DOOR_LOCK_CLEAR_RFID_CODE_COMMAND_ID (0x18)
#define DOTDOT_DOOR_LOCK_CLEAR_RFID_CODE_RESPONSE_COMMAND_ID (0x18)
#define DOTDOT_DOOR_LOCK_CLEAR_ALL_RFID_CODES_COMMAND_ID (0x19)
#define DOTDOT_DOOR_LOCK_CLEAR_ALL_RFID_CODES_RESPONSE_COMMAND_ID (0x19)
#define DOTDOT_DOOR_LOCK_SET_USER_COMMAND_ID (0x1A)
#define DOTDOT_DOOR_LOCK_GET_USER_COMMAND_ID (0x1B)
#define DOTDOT_DOOR_LOCK_GET_USER_RESPONSE_COMMAND_ID (0x1C)
#define DOTDOT_DOOR_LOCK_CLEAR_USER_COMMAND_ID (0x1D)
...
#define DOTDOT_DOOR_LOCK_SET_CREDENTIAL_COMMAND_ID (0x22)
#define DOTDOT_DOOR_LOCK_SET_CREDENTIAL_RESPONSE_COMMAND_ID (0x23)
#define DOTDOT_DOOR_LOCK_GET_CREDENTIAL_STATUS_COMMAND_ID (0x24)
#define DOTDOT_DOOR_LOCK_GET_CREDENTIAL_STATUS_RESPONSE_COMMAND_ID (0x25)
#define DOTDOT_DOOR_LOCK_CLEAR_CREDENTIAL_COMMAND_ID (0x26)
#define DOTDOT_DOOR_LOCK_UNBOLT_DOOR_COMMAND_ID (0x27)
...
#define DOTDOT_IASACE_GET_ZONE_ID_MAP_RESPONSE_COMMAND_ID (0x1)
...
#define DOTDOT_IASACE_GET_ZONE_ID_MAP_COMMAND_ID (0x5)
...
#define DOTDOT_STATE_DISCOVER_SECURITY_COMMAND_ID (0x5)
#define DOTDOT_STATE_ENABLE_NLS_COMMAND_ID (0x6)
